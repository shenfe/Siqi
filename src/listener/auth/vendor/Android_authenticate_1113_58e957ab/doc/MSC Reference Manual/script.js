...
function gShowHelp(){
	if( gIsIflytek() ){
		document.write(  "<p>在集成过程遇到问题，可通过 <b><a href=http://bbs.xfyun.cn/>语音云开发者论坛</a></b> 搜索相关的问题答案，并与其他开发者交流。</p>" );
	}
}
...
function gShowSchDefaultStatus(){
	if( gIsIflytek() ){
		document.write(  "SDK申请时，默认未开通语义理解功能（使用时报10407错误），可通过 <b><a href=http://osp.voicecloud.cn/>开放语义平台</a></b> 开通，并选择需要的语义场景。</p>" );
	}else{
		document.write(  "SDK申请时，默认未开通语义理解功能（使用时报10407错误），可联系我们开通。" );
	}
}
/*********************************	自定义函数结束	***************************************/